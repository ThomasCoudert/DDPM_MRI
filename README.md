...
A hands-on workshop notebook demonstrating **accelerated MRI reconstruction** using a Denoising Diffusion Probabilistic Model (DDPM).

> Authors: Thomas Coudert, Amit Rand, Zhengyang Ming  
> IDRE Workshop
